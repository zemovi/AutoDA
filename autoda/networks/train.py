...
from autoda.standard_augmentation import apply_standard_transform
...
# XXX: Refractor Objective function
#      - remove get_data
#      - pass data as argument and retrieve it from tuple inside function
#      - check if you can modularize objective function with train and evaluate model
    ...
    with K.tf.device("/gpu:1"):
        with session.graph.as_default():
            ...
            while(num_epochs < max_epochs) and \
                ...
                if type(configuration) == ConfigSpace.configuration_space.Configuration:
                    print("Using real-time data augmentation.")
