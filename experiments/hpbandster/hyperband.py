...
parser.add_argument(
    "--successive_halving", default=5, help="Number of successive halving for hyperband", type=int
)
...
max_epochs, batch_size, time_budget, successive_halving, augment = int(args.max_epochs), int(args.batch_size), int(args.time_budget), int(args.successive_halving),  args.augment
...
print("config_space", config_space, type(config_space))
CG = hpbandster.config_generators.RandomSampling(config_space)
print("CG", CG, "type_CG", type(CG))
