...
def train_and_test(data, configuration=None, benchmark="AlexNet", max_epochs=200, batch_size=128, time_budget=900, pipeline=None):
    # preprocess data
        ...
        with session.graph.as_default():
            ...
            while(num_epochs < max_epochs) and \
                ...
                if configuration:
                    ...
                    if benchmark == "ResNet":
                        lr_reducer = ReduceLROnPlateau(monitor='loss', factor=0.2,
...
def main():
    ...
    parser.add_argument(
        ...
        dest="pipeline",
        default="best_config",
        help="Data augmentation pipeline to use, choice:{default, no_augment, best_config, random}"
    )
    ...
    augment = args.augment or (configuration is not None)
